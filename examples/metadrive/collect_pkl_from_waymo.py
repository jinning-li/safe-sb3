########################################
#  from trafficgen utils trans20.py
#  used for parse waymo's data into pickles
...
def parse_data(args, pre_fix = None):
    MAX = 100000
    cnt = 0
    output_path = args['pkl_dir']
    input_path = args['tfrecord_dir']
    ...
    for file in tqdm(file_list):
        ...
        for j, data in enumerate(dataset.as_numpy_iterator()):
            try:
                ...
                print("current pkl", '{}.pkl'.format(cnt))
...
if __name__ == '__main__':
    ...
    #### for debug purpose #####
    # tfrecord_dir = 'data_processing/'
    # pkl_dir = 'data_processing/'
